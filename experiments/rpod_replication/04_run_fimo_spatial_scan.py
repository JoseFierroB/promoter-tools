...
OUT_ASSIGNMENTS = CURRENT_DIR / "rpod_extended10_full_assignments.tsv"
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="fimo_step4_ext_") as tmpdir:
        ...
        for _, row in df_bip_raw.iterrows():
            ...
            # Both statistical threshold and physical -35 conservation met
    ...
    # Read all sequence IDs from fasta
    all_seq_ids = []
    ...
    print("=" * 76)
    print(f"Output table saved to: {OUT_ASSIGNMENTS.name}")
    print("=" * 76)
