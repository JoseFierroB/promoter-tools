...
PROMOTER_TOOLS = {
    ...
    "cnnprom": Tool(
        ...
        pixi_env=config.promoters_dir / "pixi.toml",
        outputs=[
            ROOT / "output/predictions/cnnprom_pos.csv",
            ROOT / "output/predictions/cnnprom_neg.csv",
        ],
        model_paths=[ROOT / "output/predictions/cnnprom_ecoli_model.keras"],
        gpu_capable=True,
    ),
    "mldspp": Tool(
        name="MLDSPP XGBoost",
        ...
        outputs=[
            ROOT / "output/predictions/mldspp_transfer_pos.csv",
            ROOT / "output/predictions/mldspp_transfer_neg.csv",
        ],
        model_paths=[],
        gpu_capable=False,
