...
OUTPUT_JSON = Path(__file__).resolve().parent.parent / "motifs" / "d39v_500bp_upstream_background.json"
...
def compute_background(genome_fasta: Path) -> dict:
    ...
    if not gff_path:
        raise FileNotFoundError("Could not find TSS GFF or metadata file.")
